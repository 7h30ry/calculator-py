...
me.geometry('354x460')
me.title('CALCULATOR')
melabel = Label(me, text='CALCULATOR', bg='dark grey', font=('Times',20,'bold'))
...
butdot=Button(me, padx=47, pady=14, bd=4, bg='white', text='.', command=lambda:clickbut('.'), font=('Courier New',16,'bold'))
